<div class="modal fade" id="tempDrugSearchModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table id="drug" class="table table-bordered table-sm align-items-center dtab" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="sort text-center">จำนวนคงเหลือ</th>
                                <th scope="col"></th>
                            </tr>
                        </thead>
                        <tbody class="list">
